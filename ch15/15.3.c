// pola.c - definiuje i korzysta z pól
#include <stdio.h>
...
const char *kolory[8] = {"czarny", "czerwony", "zielony", "zolty", "niebieski", "fioletowy",
"zielononiebieski", "bialy"};
...
int main(void){
    ...
    case KROPKI:    printf("wykreskowana.\n");  break;
    ...
    printf("Kolorem wypelnia jest %s.\n", kolory[okno.kolor_wyp]);
    printf("Kolorem ramki jest %s.\n", kolory[okno.kolor_ramki]);
