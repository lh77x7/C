// filmy3.c -- korzystanie z listy łączonej zgodnie z ATD
#include <stdio.h>
#include <stdlib.h> // prototyp funkcji exit()
#include "lista2.h"  // definiuje typy Lista, Pozycja
...
int main(void){
    ...
    while (gets(tymcz.tytyul) != NULL && tymcz.tytyul[0] != '\0')
    {
        puts("Podaj Twoje ocene <0-10>:");
        scanf("%d", &tymcz.ocena);
        while (getchar() != '\n')
            continue;
